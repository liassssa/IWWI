...
public class ElytraAutoFly extends Module {
    ...
    public ElytraAutoFly() {
        super(AddonTemplate.CATEGORY, "elytra-auto-fly", "Auto Elytra flight with airplane-style landing.");
    }
        ...
        switch (stage) {
            ...
            case ASCENDING -> {
                if (isElytraLowDurability()) {
                    emergencyLand("⚠️ Elytra durability below 15%! Emergency landing.");
                    return;
                }
            ...
            case DESCENDING -> {
                ...
                if (distance > 2) {
                    ...
                    mc.options.forwardKey.setPressed(false);
                    mc.player.setPitch(10f); // flare before landing
                }
    ...
    private void emergencyLand(String message) {
